...
app.use(mcpServerUrl.pathname, async (req, res, next) => {
  ...
  accessTokenForRequest = proxyClient.identityAuthAccessToken;
  ...
  if (!userInfo) {
    ...
    proxyClient['identityAuthAccessToken'] = refreshTokenGrant.access_token;
    proxyClient['identityAuthSignature'] = refreshTokenGrant.signature;
    proxyClient['identityAuthScope'] = refreshTokenGrant.scope;
    proxyClient['identityAuthTokenType'] = refreshTokenGrant.token_type;
    proxyClient['identityAuthIssuedAt'] = refreshTokenGrant.issued_at;
  ...
  console.log('/mcp authorized', proxyClient.identityAuthId);
