...
import provider_config from './support/provider-config.js';
...
provider_config.findAccount = Account.findAccount;
...
const provider = new Provider(BASE_URL, provider_config);
...
app.get('/.well-known/oauth-authorization-server', async (_req, res) => {
  res.json({
    ...
    "authorization_endpoint":
      `${BASE_URL}${provider_config.routes.authorization}`,
    "token_endpoint":
      `${BASE_URL}${provider_config.routes.token}`,
    "userinfo_endpoint":
      `${BASE_URL}${provider_config.routes.userinfo}`,
    "jwks_uri":
      `${BASE_URL}${provider_config.routes.jwks}`,
    "registration_endpoint":
      `${BASE_URL}${provider_config.routes.registration}`,
    "scopes_supported":
