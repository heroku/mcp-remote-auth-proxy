...
const provider = new Provider(BASE_URL, configuration);
...
app.get('/.well-known/oauth-authorization-server', async (_req, res) => {
  res.json({
    ...
    "authorization_endpoint":
      `${BASE_URL}${configuration.routes.authorization}`,
    "token_endpoint":
      `${BASE_URL}${configuration.routes.token}`,
    "userinfo_endpoint":
      `${BASE_URL}${configuration.routes.userinfo}`,
    "jwks_uri":
      `${BASE_URL}${configuration.routes.jwks}`,
    "registration_endpoint":
      `${BASE_URL}${configuration.routes.registration}`,
    "scopes_supported":
