...
app.get('/.well-known/oauth-authorization-server', async (_req, res) => {
  res.json({
    ...
    "authorization_endpoint":
      `${ISSUER}${configuration.routes.authorization}`,
    "token_endpoint":
      `${ISSUER}${configuration.routes.token}`,
    "userinfo_endpoint":
      `${ISSUER}${configuration.routes.userinfo}`,
    "jwks_uri":
      `${ISSUER}${configuration.routes.jwks}`,
    "registration_endpoint":
      `${ISSUER}${configuration.routes.registration}`,
    "scopes_supported":
...
// app.get('/.well-known/oauth-protected-resource', async (_req: express.Request, res: express.Response) => {
//   res.json({
//     "resource": `http://localhost:${PORT}`,
//     "resource_name": "Heroku MCP Server",
