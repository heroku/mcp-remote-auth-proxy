...
/**
 * Legacy compatibility - get identity scope
 * @returns {string} Identity scope
 */
...
/**
 * Legacy compatibility - get OIDC adapter instance
 * @returns {OIDCProviderAdapter | null} OIDC adapter
 */
